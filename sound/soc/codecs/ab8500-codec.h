...
#define AB8500_PWMGENCONF4			0x12	/* Only on AB8500 */
#define AB8505_IPWMACFREQ			0x12
#define AB8500_PWMGENCONF5			0x13	/* Only on AB8500 */
...
#define AB8500_CLASSDCONF2			0x3C	/* Only on AB8500 */
#define AB8500_CLASSDCONF3			0x3D	/* Only on AB8500 */
...
#define AB8505_EPWM1CONF			0x70
#define AB8505_EPWM2CONF			0x71
#define AB8505_DMICFREQ				0x72
#define AB8505_USBHSGAIN			0x73
#define AB8505_USBDRVCTRL			0x74
#define AB8505_EARGAINMICSEL			0x75
#define AB8505_PDMCTRL				0x76
#define AB8505_CIDEMICTRL			0x77
#define AB8505_HFGAINCTRL_V1			0x78
#define AB8505_VIBGAINCTRL_V1			0x79
#define AB8505_EPWM1ACDCA			0x7A
#define AB8505_EPWM1ACDCB			0x7B
#define AB8505_EPWM1ACFREQ			0x7C
#define AB8505_EPWM2ACDCA			0x7D
#define AB8505_EPWM2ACDCB			0x7E
#define AB8505_EPWM2ACFREQ			0x7F
#define AB8505_HFLGAINCTRL_V2			0x80
#define AB8505_HFRGAINCTRL_V2			0x81
#define AB8505_VIBGAINCTRL_V2			0x82
#define AB8505_MIXCTRL				0x83
...
#define AB8505_ADPATHENA_SELIN			1
#define AB8505_ADPATHENA_LPADC3			0
...
#define AB8500_DAPATHENA_ENHPEAR		1
...
/* AB8500_DIGMICCONF */
#define AB8500_DIGMICCONF_ENDMIC1		7	/* No DMIC on AB8505 */
#define AB8500_DIGMICCONF_ENDMIC2		6	/* No DMIC on AB8505 */
#define AB8500_DIGMICCONF_ENDMIC3		5	/* No DMIC on AB8505 */
#define AB8500_DIGMICCONF_ENDMIC4		4	/* No DMIC on AB8505 */
#define AB8500_DIGMICCONF_ENDMIC5		3	/* No DMIC on AB8505 */
#define AB8500_DIGMICCONF_ENDMIC6		2	/* No DMIC on AB8505 */
...
#define AB8500_ANACONF4_ENVIB2			0	/* Only on AB8500 */

/* AB8500_DAPATHCONF */
#define AB8500_DAPATHCONF_CPLFMD		7
...
#define AB8500_DAPATHCONF_ENDACVIB2		0	/* Only on AB8500 */
...
#define AB8500_PWMGENCONF1_PWMTOVIB2		6	/* Only on AB8500 */
#define AB8500_PWMGENCONF1_PWM1CTRL		5
#define AB8500_PWMGENCONF1_PWM2CTRL		4	/* Only on AB8500 */
#define AB8500_PWMGENCONF1_PWM1NCTRL		3
#define AB8500_PWMGENCONF1_PWM1PCTRL		2
#define AB8500_PWMGENCONF1_PWM2NCTRL		1	/* Only on AB8500 */
#define AB8500_PWMGENCONF1_PWM2PCTRL		0	/* Only on AB8500 */
...
#define AB8500_CLASSDCONF1_PARLVIB		6	/* Only on AB8500 */
#define AB8500_CLASSDCONF1_VIB1SWAPEN		3	/* Only on AB8500 */
#define AB8500_CLASSDCONF1_VIB2SWAPEN		2	/* Only on AB8500 */
#define AB8500_CLASSDCONF1_HFLSWAPEN		1	/* Only on AB8500 */
#define AB8500_CLASSDCONF1_HFRSWAPEN		0	/* Only on AB8500 */
...
#define AB8500_DMICFILTCONF_DMIC1SINC3		5	/* No DMIC on AB8505 */
#define AB8500_DMICFILTCONF_DMIC2SINC3		4	/* No DMIC on AB8505 */
#define AB8500_DMICFILTCONF_DMIC3SINC3		3	/* No DMIC on AB8505 */
#define AB8500_DMICFILTCONF_DMIC4SINC3		2	/* No DMIC on AB8505 */
#define AB8500_DMICFILTCONF_DMIC5SINC3		1	/* No DMIC on AB8505 */
#define AB8500_DMICFILTCONF_DMIC6SINC3		0	/* No DMIC on AB8505 */
...
/* AB8505_IPWMACFREQ */
#define AB8505_IPWMACFREQ_FREQ_MAX		0xC8
#define AB8505_IPWMACFREQ_FREQ			0

/* AB8505_EPWM1CONF */
#define AB8505_EPWM1CONF_EDGE			7
#define AB8505_EPWM1CONF_TOHFR			6
#define AB8505_EPWM1CONF_EN			4
#define AB8505_EPWM1CONF_FREQ_MAX		0xF
#define AB8505_EPWM1CONF_FREQ			0

/* AB8505_EPWM2CONF */
#define AB8505_EPWM2CONF_EDGE			7
#define AB8505_EPWM2CONF_TOHFL			6
#define AB8505_EPWM2CONF_GPIOSEL		5
#define AB8505_EPWM2CONF_EN			4
#define AB8505_EPWM2CONF_FREQ_MAX		0xF
#define AB8505_EPWM2CONF_FREQ			0

/* AB8505_DMICFREQ */
#define AB8505_DMICFREQ_AD12LBMONO		7
#define AB8505_DMICFREQ_MIC12FREQ		4
#define AB8505_DMICFREQ_MIC34FREQ		2
#define AB8505_DMICFREQ_MIC56FREQ		0
#define AB8505_DMICFREQ_MICxxFREQ_MAX		0x3

/* AB8505_USBHSGAIN */
#define AB8505_USBHSGAIN_UHSL			4
#define AB8505_USBHSGAIN_UHSX_MAX		0xF
#define AB8505_USBHSGAIN_UHSR			0

/* AB8505_USBDRVCTRL */
#define AB8505_USBDRVCTRL_ENCKLOL		7
#define AB8505_USBDRVCTRL_ENCKLOR		6
#define AB8505_USBDRVCTRL_ENCKLOLDM		5
#define AB8505_USBDRVCTRL_ENCKLORDP		4
#define AB8505_USBDRVCTRL_MUTEUHSL		3
#define AB8505_USBDRVCTRL_MUTEUHSR		2
#define AB8505_USBDRVCTRL_ENUHSL		1
#define AB8505_USBDRVCTRL_ENUHSR		0

/* AB8505_EARGAINMICSEL */
#define AB8505_EARGAINMICSEL_USBMICSEL_SHIFT	4
#define AB8505_EARGAINMICSEL_GAIN_MAX		0x8
#define AB8505_EARGAINMICSEL_GAIN		0

/* AB8505_PDMCTRL */
#define AB8505_PDMCTRL_UHSSEL			6
#define AB8505_PDMCTRL_D1TOHFR			5
#define AB8505_PDMCTRL_D5TOHFL			4
#define AB8505_PDMCTRL_D6TOHFL			4
#define AB8505_PDMCTRL_ENPDM1			1
#define AB8505_PDMCTRL_ENPDM2			0

/* AB8505_CIDEMICTRL */
#define AB8505_CIDEMICTRL_DALOWHFNOI		7
#define AB8505_CIDEMICTRL_PWMACMODE		4
#define AB8505_CIDEMICTRL_MAX			2

/* AB8505_EPWM1ACDCA */
#define AB8505_EPWM1ACDCA_ACSEL			7
#define AB8505_EPWM1ACDCA_ACDCA_MAX		0x64
#define AB8505_EPWM1ACDCA_ACDCA			0

/* AB8505_EPWM1ACDCB */
#define AB8505_EPWM1ACDCB_ACDCB_MAX		0x64
#define AB8505_EPWM1ACDCB_ACDCB			0

/* AB8505_EPWM1ACFREQ */
#define AB8505_EPWM1ACFREQ_FREQ_MAX		0xFF

/* AB8505_EPWM2ACDCA */
#define AB8505_EPWM2ACDCA_ACDCA_MAX		0x64
#define AB8505_EPWM2ACDCA_ACSEL			7
#define AB8505_EPWM2ACDCA_ACDCA			0

/* AB8505_EPWM2ACDCB */
#define AB8505_EPWM2ACDCB_ACDCB_MAX		0x64
#define AB8505_EPWM2ACDCB_ACDCB			0

/* AB8505_EPWM2ACFREQ */
#define AB8505_EPWM2ACFREQ_FREQ_MAX		0xFF

/* AB8505_HFGAINCTRL_V1 (ab8505 v1) */
#define AB8505_HFGAINCTRL_V1_HFL		4
#define AB8505_HFGAINCTRL_V1_HFR		0
#define AB8505_HFGAINCTRL_V1_HFX_MAX		0xF

/* AB8505_VIBGAINCTRL_V1 (ab8505 v1) */
#define AB8505_VIBGAINCTRL_V1_SHIFT		4
#define AB8505_VIBGAINCTRL_V1_MAX		0xF

/* AB8505_HFGAINCTRL_V2 (ab8505 v2) */
#define AB8505_HFGAINCTRL_V2_SHIFT		0
#define AB8505_HFGAINCTRL_V2_MAX		0x18

/* AB8505_VIBGAINCTRL_V2 (ab8505 v2) */
#define AB8505_VIBGAINCTRL_V2_SHIFT		0
#define AB8505_VIBGAINCTRL_V2_MAX		0x18

/* AB8505_MIXCTRL */
#define AB8505_MIXCTRL_DA78MONO			4
#define AB8505_MIXCTRL_DA7ADDDA1		3
#define AB8505_MIXCTRL_DA8ADDDA2		2
#define AB8505_MIXCTRL_DA7ADDDA3		1
#define AB8505_MIXCTRL_DA8ADDDA4		0
